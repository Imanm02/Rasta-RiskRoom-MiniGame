...
if __name__ == '__main__':
    ...
    questions = [
        Question('در مورد تاثیر غلظت سرب در خون بر افزایش میزان خشونت کدام مورد درست است؟', [
            ...
            'از روی شباهت و همبستگی نمودارهای غلظت سرب در خون کودکان و افزایش جرم و خشونت می‌توان به وجود ارتباط قطعی بین این دو عامل پی برد.',
            'هیچکدام',
        ], 3),
...
اگر دهانه دو بادکنک را به هم وصل کنیم، جریان چگونه برگزار می‌شود؟""", [
        ...
        Question('سوراخ کوچکی در انتهای بطری  پرآبی ایجاد کرده و از سطح بلندی آن را رها می‌کنیم. حالت خارج شدن آب چگونه است؟', [
            'خارج می‌شود',
            'خارج نمی‌شود',
